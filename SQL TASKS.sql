...
-- Combined company and employee data into one dataset and added two new columns:
-- one to calculate salary plus bonus, and one to check if that total 
-- matches the compensation figure already provided in the data.
...
-- Thresholds were based on quartile distribution:
-- Low < £70,000               (below Q1: £69,680)
-- Med £70,000 - £109,999      (between Q1 and Q3) 
-- High £110,000 +             (above Q3: £109,200)
-- Min: £23,457  ,  Median: £ 84,522  ,  Max: £2,983,784
WITH joined_tables AS (
	SELECT 
		c.Install,
        c.XHR_Sector_Grouped,
